...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ik)f+hj0ax%2$90i+gpif(rp*m40aoimvj7kvuanbgu+i6t@x_')
...
# Session backend (use Redis in production, database in development)
if not DEBUG:
